...
class DividerItemDecoration(
    context: Context,
    private val paddingLeft: Int = DEFAULT_PADDING_DP.toPx(context),
    private val paddingRight: Int = DEFAULT_PADDING_DP.toPx(context),
    private val thickness: Int = DEFAULT_THICKNESS_DP.toPx(context),
